...
// NEW COMPONENT: neuron background
    ...
    <>
      ...
      <div className={`navbar-img${darkMode ? " dark" : ""}`}>
        ...
        <div className="nav-img-center">
          <a href="#" className="nav-img-link">ABOUT <span className="nav-img-link-arrow">→</span></a>
          <a href="#" className="nav-img-link">WORK <span className="nav-img-link-arrow">→</span></a>
          <a href="#" className="nav-img-link">CONTACT <span className="nav-img-link-arrow">→</span></a>
        </div>

        <div className="nav-img-icons-group">
          <div className="nav-img-icons-fullheight-divider"></div>
          <div className="nav-img-icons-col">
            <a href="https://github.com/YourGitHubUsername" target="_blank" className="nav-img-icon">
              <FaGithub />
            </a>
            <div className="nav-img-hr-full"></div>
            <a href="https://www.linkedin.com/in/ruhela-kritika/" target="_blank" className="nav-img-icon">
              <FaLinkedinIn />
            </a>
          </div>
          <div className="nav-img-icons-fullheight-divider nav-img-icons-spacer-divider"></div>
          <button className="nav-img-icon theme-toggle" onClick={() => setDarkMode((prev) => !prev)}>
        ...
        <div className="nav-img-right">
          ...
          <div className="nav-img-right-bottom">Available for work → <span className="nav-img-hire">Hire me</span></div>
        </div>
      </div>
